    ...
    ***************************************************************************** */
    ...
    var DocumentCloner = /** @class */ (function () {
        function DocumentCloner(context, element, options) {
            ...
            this.documentElement = this.cloneNode(firstElement.ownerDocument.documentElement, false);
        }
        DocumentCloner.prototype.toIFrame = function (ownerDocument, windowSize) {
            ...
            var iframeLoad = iframeLoader(iframe).then(function () { return __awaiter(_this, void 0, void 0, function () {
                var onclone, referenceElement, referenceElements_1, nodeNames;
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (typeof referenceElement === 'undefined' ||
                                ...
                                referenceElements_1 = Array.isArray(this.referenceElement)
                                    ? this.referenceElement
                                    : [this.referenceElement];
                                nodeNames = referenceElements_1.map(function (el) { return el.nodeName; }).join(', ');
                                return [2 /*return*/, Promise.reject("Error finding the ".concat(nodeNames, " in the cloned document"))];
                            }
                            ...
                            if (typeof onclone === 'function') {
                                return [2 /*return*/, Promise.resolve()
                                        ...
                                        if (Array.isArray(referenceElement)) {
                                            referenceElement.forEach(function (el) { return onclone(documentClone, el); });
                                        }
                                        else {
            ...
            documentClone.open();
            documentClone.write("".concat(serializeDoctype(ownerDocument.doctype), "<html></html>"));
            // Chrome scrolls the parent document for some reason after the write to the cloned window???
            var referenceElements = Array.isArray(this.referenceElement)
                ? this.referenceElement
                : [this.referenceElement];
        ...
        DocumentCloner.prototype.cloneNode = function (node, copyStyles) {
            ...
            if (window && isElementNode(node) && (isHTMLElementNode(node) || isSVGElementNode(node))) {
                ...
                var referenceElements = Array.isArray(this.referenceElement)
                    ? this.referenceElement
                    : [this.referenceElement];
                var matchingIndex = referenceElements.indexOf(node);
                if (matchingIndex !== -1 && isHTMLElementNode(clone)) {
                    if (Array.isArray(this.referenceElement)) {
                        ...
                        var clonedArray = this.clonedReferenceElement;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            element.styles.visibility = 0 /* VISIBILITY.VISIBLE */;
                    ...
                    switch (_0.label) {
                        ...
                        case 1:
                            ...
                            for (_i = 0, clonedElements_1 = clonedElements; _i < clonedElements_1.length; _i++) {
                                ...
                                if (!el)
                                    continue;
                                bounds = isBodyElement(el) || isHTMLElement(el) ? parseDocumentSize(el.ownerDocument) : parseBounds(context, el);
                                                    ...
                                                    return __generator(this, function (_c) {
                                                        switch (_c.label) {
                                                            case 0:
                                                                ...
                                                                elementBounds = isBodyElement(el) || isHTMLElement(el)
                                                                ...
                                                                renderer = new ForeignObjectRenderer(context, elementRenderOptions);
                                                    ...
                                                    return __generator(this, function (_c) {
                                                        switch (_c.label) {
                                                            case 0:
                                                                ...
                                                                renderer = new CanvasRenderer(context, elementRenderOptions);
        ...
        return __generator(this, function (_t) {
            switch (_t.label) {
                ...
                case 1:
                    ...
                    combinedBounds = isBodyElement(clonedElement) || isHTMLElement(clonedElement)
